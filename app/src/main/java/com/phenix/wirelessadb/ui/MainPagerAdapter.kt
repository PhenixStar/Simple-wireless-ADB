 ...
 *
 * TAB STRUCTURE (v1.3.0 - With Statistics):
 * ==========================================
 ...
 * Tab 2: StatisticsFragment - Connection statistics dashboard
 * Tab 3: HelpFragment       - Help docs, downloads, theme settings
 *
 * v1.3.0 Changes:
 * - Replaced DashboardFragment + RemoteRelayFragment with ControlFragment
 * - Added DevicesFragment for trusted device management
 * - Added StatisticsFragment for connection metrics
 * - Reduced complexity: 4 focused tabs instead of redundant UI
 */
class MainPagerAdapter(activity: FragmentActivity) : FragmentStateAdapter(activity) {
  ...
  override fun createFragment(position: Int): Fragment {
    return when (position) {
      ...
      TAB_STATISTICS -> StatisticsFragment() // Tab 2: Connection statistics
      TAB_HELP -> HelpFragment()            // Tab 3: Help & downloads
  ...
  companion object {
    ...
    const val TAB_STATISTICS = 2  // StatisticsFragment: Connection statistics
    const val TAB_HELP = 3        // HelpFragment: Help & downloads
  }
}
